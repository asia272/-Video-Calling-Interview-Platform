...
function CommentDialog({ interviewId }: { interviewId: Id<"interviews"> }) {
    ...
    const interviewComments = useQuery(api.comment.getComments, { interviewId });
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline">
                                    {interviewComments.length} Comment{interviewComments.length !== 1 ? "s" : ""}
                                </Badge>
                            </div>
                            {/* Display existing comment for and individule interview */}
                            <ScrollArea className="h-[240px]">

                                <div className="space-y-4">
                                    {interviewComments.map((comment, idx) => {
